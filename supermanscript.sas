...
%macro regBootTwo(NumberOfLoops, DataSet, XVariable, YVariable);
	...
	ods rtf file = 'C:\Users\Lenovo\Desktop\SAS_project\teamOutput.rtf';
		proc means data = ResultHolder2 mean lclm uclm alpha = 0.025;
...
data work.Test;
       infile 'C:\Users\Lenovo\Desktop\SAS_project\fitness.csv' dlm = ',' firstobs = 2;
...
/*%regBoot(NumberOfLoops=10, DataSet=work.Test, XVariable=Age, YVariable=Weight);*/
